...
export const mockBackend: backendInterface = {
  ...
  adminLogin: async (password) => password === "MUNNA12061" ? "mock-admin-token-123" : null,
  approveMember: async (_id, _adminSignature) => true,
  ...
  listNotices: async (_includeArchived) => mockNotices,
  ...
  getSiteSettings: async () => ({ adminSignature: "মোহাম্মদ আলী, আহ্বায়ক", centerName: "কেন্দ্রীয় কমিটি", siteName: "২নং কপিলমুনি ইউনিয়ন ছাত্রদল", upazilaName: "পাইকগাছা", unionName: "কপিলমুনি" }),
  updateSiteSettings: async (_newSettings) => undefined,
  updateMemberDesignation: async (_id, _newDesignation, _newRank) => true,
